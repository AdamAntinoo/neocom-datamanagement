...
public class MarketServiceTest {
	...
	public void constructorContract() {
		final MarketService marketService = new MarketService( this.esiDataService );
	...
	public void getMarketHubSellOrders4Id() {
		...
		orders.add( order4 );
		// When
		Mockito.when( this.esiDataService.getRegionMarketHub( TARGET_REGION_ID ) ).thenReturn( regionHub );
