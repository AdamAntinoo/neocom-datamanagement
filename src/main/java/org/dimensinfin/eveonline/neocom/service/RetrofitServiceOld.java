...
public class RetrofitServiceOld {
	...
	@Inject
	public RetrofitServiceOld( @NotNull @Named(DMServicesDependenciesModule.ICONFIGURATION_SERVICE) final IConfigurationService configurationProvider,
